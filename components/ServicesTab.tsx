...
import { Plus, Edit2, Trash2, Clock, Upload, Image as ImageIcon } from 'lucide-react';
...
export const ServicesTab: React.FC<Props> = ({ services, onUpdateServices }) => {
  ...
  const startNew = () => {
    setEditingId(0);
    setFormState({ duration: 30, cleaning_buffer: 0, price: 0, description: '', imageUrl: '', imageOpacity: 40 });
  };
